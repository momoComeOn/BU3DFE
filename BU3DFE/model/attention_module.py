...
class AttentionModule_VGG_stage0(nn.Module):
    # input size is 112*112
    def __init__(self, lists, in_channels=64, out_channels=64, size1=(112, 112), size2=(56, 56), size3=(28, 28), size4=(14, 14)):
        super(AttentionModule_VGG_stage0, self).__init__()

        self.trunk_branches = lists
...
class AttentionModule_VGG_stage1(nn.Module):
    # input size is 56*56
    def __init__(self, lists, in_channels=128, out_channels=128, size1=(56, 56), size2=(28, 28), size3=(14, 14)):
        super(AttentionModule_VGG_stage1, self).__init__()
...
class AttentionModule_VGG_stage2(nn.Module):
    # input image size is 28*28
    def __init__(self, lists, in_channels=256, out_channels=256, size1=(28, 28), size2=(14, 14)):
        super(AttentionModule_VGG_stage2, self).__init__()
...
class AttentionModule_VGG_stage3(nn.Module):
    # input image size is 14*14
    def __init__(self, lists, in_channels=512, out_channels=512, size1=(14, 14)):
        super(AttentionModule_VGG_stage3, self).__init__()
